...
energy = [0.04, 83.61, 166.92, 250.29,333.82, 417.65, 501.91, 586.8, 672.55, 759.47, 847.92, 938.39, 1031.6, 1128.5]
...
# find the volume values
    ...
    for x in templist:
        if usertemp != x:
            ...
            break
    actual_vol = volume[position]
    actual_ene = energy[position]
    actual_enth = enthalpy[position]
    actual_ent = entropy[position]
        
   # print(position)
    #actual_volume = volume[min_index]
